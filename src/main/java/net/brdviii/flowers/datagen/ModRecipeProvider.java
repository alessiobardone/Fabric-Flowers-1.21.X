        ...
        return new RecipeGenerator(wrapperLookup,recipeExporter) {
            ...
            public void generate() {
                ...
                for (var entry : smallDyeMap.entrySet()) {
                    ...
                    ShapelessRecipeJsonBuilder builder = createShapeless(RecipeCategory.MISC, dye, 1)
                            .input(ingredient);

                    for (ItemConvertible flower : flowers) {
                        builder.criterion("has_" + RecipeGenerator.getRecipeName(flower), conditionsFromItem(flower));
                    }

                    builder.offerTo(exporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(Flowers.MOD_ID, RecipeGenerator.getRecipeName(dye) + "_from_flowers")));
                }
                ...
                for (var entry : tallDyeMap.entrySet()) {
                    ...
                    ShapelessRecipeJsonBuilder builder = createShapeless(RecipeCategory.MISC, dye, 2)
                            .input(ingredient);
                    ...
                    builder.offerTo(exporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(Flowers.MOD_ID, RecipeGenerator.getRecipeName(dye) + "_from_tall_flowers")));
                }
            }
        };
    }
