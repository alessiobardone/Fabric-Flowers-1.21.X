...
public class ModConfiguredFeatures {
    ...
    public static final RegistryKey<ConfiguredFeature<?, ?>> LARGE_LILY_KEY = registerKey("large_lily_key");
    public static final RegistryKey<ConfiguredFeature<?, ?>> LIGHT_LILY_KEY = registerKey("light_lily_key");
    public static final RegistryKey<ConfiguredFeature<?, ?>> SMALL1_KEY = registerKey("small1_key");
    public static final RegistryKey<ConfiguredFeature<?, ?>> SMALL2_KEY = registerKey("small2_key");
    ...
    static Map<Block, Integer> large_lily = Map.of(
            ModBlocks.LAVANDER_LARGE_LILY,1,
            ModBlocks.JOY_LARGE_LILY,1,
            ModBlocks.PURPLE_LARGE_LILY,1,
            ModBlocks.SUNFIRE_LARGE_LILY,1
    );

    static Map<Block, Integer> light_lily = Map.of(
            ModBlocks.LAVANDER_LIGHT_LILY,1,
            ModBlocks.JOY_LIGHT_LILY,1,
            ModBlocks.PURPLE_LIGHT_LILY,1,
            ModBlocks.SUNFIRE_LIGHT_LILY,1
    );

    static Map<Block, Integer> small1 = Map.of(
            ModBlocks.WATER_LILY_SMALL,1,
            Blocks.LILY_PAD,1,
            ModBlocks.CLOVER_LILY,1
    );

    static Map<Block, Integer> small2 = Map.of(
            ModBlocks.CLOVER_LILY,1,
            ModBlocks.FROGBIT,1,
            Blocks.LILY_PAD,1,
            ModBlocks.WATER_LILY_SMALL,1
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, LARGE_LILY_KEY, Feature.RANDOM_PATCH,
                createMixedPatch(large_lily,32));

        register(context, LIGHT_LILY_KEY, Feature.RANDOM_PATCH,
                createMixedPatch(light_lily,32));

        register(context, SMALL1_KEY, Feature.RANDOM_PATCH,
                createMixedPatch(small1,32));

        register(context, SMALL2_KEY, Feature.RANDOM_PATCH,
                createMixedPatch(small2,32));
    }
