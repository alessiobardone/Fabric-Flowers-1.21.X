...
public class WisteriaPurpleBlock extends Block implements Fertilizable {
    public static final BooleanProperty CAN_GROW = BooleanProperty.of("can_grow");

    public WisteriaPurpleBlock(Settings settings) {
    ...
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        if (world.isAir(below)) {
            world.setBlockState(pos, ModBlocks.WISTERIA_PURPLE_PLANT.getDefaultState());
            world.setBlockState(below, ModBlocks.WISTERIA_PURPLE.getDefaultState());
        }
    }
