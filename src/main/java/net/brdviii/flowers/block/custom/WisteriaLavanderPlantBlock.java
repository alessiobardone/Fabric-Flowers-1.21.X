...
public class WisteriaLavanderPlantBlock extends Block {
    public WisteriaLavanderPlantBlock(AbstractBlock.Settings settings) {
        super(settings);
    }
    ...
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        if (world.isAir(below)) {
            world.setBlockState(below, ModBlocks.WISTERIA_LAVANDER_PLANT.getDefaultState());
        }
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        ...
        if (!state.isOf(newState.getBlock())) {
            ...
            while (true) {
                ...
                if (belowState.isOf(ModBlocks.WISTERIA_LAVANDER_PLANT) || belowState.isOf(ModBlocks.WISTERIA_LAVANDER)) {
