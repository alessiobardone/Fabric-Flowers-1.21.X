...
public class WisteriaPurplePlantBlock extends Block {
    public WisteriaPurplePlantBlock(AbstractBlock.Settings settings) {
        super(settings);
    }
    ...
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        if (world.isAir(below)) {
            world.setBlockState(below, ModBlocks.WISTERIA_PURPLE_PLANT.getDefaultState());
        }
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (!state.isOf(newState.getBlock())) {
            ...
            if (aboveState.isOf(ModBlocks.WISTERIA_PURPLE_PLANT)) {
                world.setBlockState(abovePos, ModBlocks.WISTERIA_PURPLE.getDefaultState(), 3);
            }
            ...
            while (true) {
                ...
                if (belowState.isOf(ModBlocks.WISTERIA_PURPLE_PLANT) || belowState.isOf(ModBlocks.WISTERIA_PURPLE)) {
